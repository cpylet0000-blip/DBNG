...
export const LotteryWinnersDisplay = () => {
  ...
  const getWinnerBackground = (position: number) => {
    switch (position) {
      case 1:
        return 'bg-linear-to-r from-yellow-500/20 to-yellow-600/20 border-yellow-400/50';
      case 2:
        return 'bg-linear-to-r from-gray-400/20 to-gray-500/20 border-gray-300/50';
      case 3:
        return 'bg-linear-to-r from-amber-600/20 to-amber-700/20 border-amber-500/50';
      default:
        return 'bg-linear-to-r from-purple-400/20 to-purple-500/20 border-purple-300/50';
    }
  };
